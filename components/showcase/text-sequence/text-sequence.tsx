...
export default function TextSequence() {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative flex min-h-100 w-full items-center justify-center text-[10vw] uppercase transition-colors duration-500",
    ...
    >
      ...
      {gray && (
        <motion.button
          ...
          className="absolute bottom-8 rounded-full bg-white px-6 py-3 text-sm font-medium text-black transition-colors hover:bg-gray-200"
        >
          Replay
        </motion.button>
      )}
